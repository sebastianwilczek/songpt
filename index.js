import { getSpotifyAccessToken, getSpotifyAccountAccessToken, getSpotifyTrackForTitle, createSpotifyPlaylist } from "./src/spotify.js";
import { generateSuggestionsBasedOnSongs, generateSuggestionsBasedOnKeywords } from "./src/openai.js";

export * from "./src/openai.js";
export * from "./src/spotify.js";
 ...
 * @param {string} playlistName The name of the playlist to create.
 * @param {string} playlistDescription The description of the playlist to create.
 * @param {Array} songTitles The song titles to base the playlist on.
 * @return {Promise} The Spotify playlist ID.
 */
export const generatePlaylistBasedOnSongs = async (openAiApiKey, spotifyCredentials, spotifyRefreshToken, spotifyAccountId, playlistName, playlistDescription, songTitles) => {
 ...
 * @return {Promise} The Spotify playlist ID.
 */
export const generatePlaylistBasedOnKeywords = async (openAiApiKey, spotifyCredentials, spotifyRefreshToken, spotifyAccountId, playlistName, playlistDescription, keywords) => {
